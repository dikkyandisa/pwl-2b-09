...
<html lang="en">
<head>
	<title>DP COMPANY PRODUCT</title>
		...
		<div class="row">
			<div class="col-md-4 col-sm-6">
				<div class="divider-wrapper divider-one">
                    ...
                    <a rel="nofollow" href="isiproduk1" class="btn btn-default">Lihat</a>
                </div>
			</div>
			<div class="col-md-4 col-sm-6">
				<div class="divider-wrapper divider-two">
					...
					<h2>Phone</h2>
					<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet.</p>
                    <a rel="nofollow" href="isiproduk2" class="btn btn-default">Lihat</a>
                </div>
			</div>
			<div class="col-md-4 col-sm-12">
				<div class="divider-wrapper divider-three">
					...
					<h2>Accessoris</h2>
					<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet.</p>
                    <a rel="nofollow" href="isiproduk3" class="btn btn-default">Lihat</a>
                </div>
			</div>
		</div>
	</div>
