	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="portfolio" class="active">NEWS</a></li>
         ...
         <div class="row mt30">
			<div class="col-md-4 col-sm-4 col-xs-9">
				<div class="team-wrapper">
					<img src="images/news1.jpg" class="img-responsive" alt="team img">
					<h3>POLITIK</h3>
					<a rel="nofollow" href="isinews1" class="btn btn-default">Lihat</a>
				</div>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-9">
				<div class="team-wrapper">
					<img src="images/news2.jpg" class="img-responsive" alt="team img">
					<h3>BENCANA</h3>
					<a rel="nofollow" href="isinews2" class="btn btn-default">Lihat</a>
				</div>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-9">
				<div class="team-wrapper">
					<img src="images/news3.jpg" class="img-responsive" alt="team img">
					<h3>KRIMINAL</h3>
					<a rel="nofollow" href="isinews3" class="btn btn-default">Lihat</a>
				</div>
			</div>
         </div>
		</div>
