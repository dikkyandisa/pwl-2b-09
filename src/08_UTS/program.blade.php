...
<html lang="en">
<head>
	<title>D COMPANY ABOUT-US</title>
         ...
         <div class="row mt30">
			<div class="col-md-4 col-sm-4 col-xs-9">
				<div class="team-wrapper">
                    ...
                    <a rel="nofollow" href="isiprogram1" class="btn btn-default">Lihat</a>
				</div>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-9">
				<div class="team-wrapper">
					<h3>PENDIDIKAN</h3>
					<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismo.</p>
                    <a rel="nofollow" href="isiprogram2" class="btn btn-default">Lihat</a>
				</div>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-9">
				<div class="team-wrapper">
					<h3>HIBURAN</h3>
					<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismo.</p>
                    <a rel="nofollow" href="isiprogram3" class="btn btn-default">Lihat</a>
				</div>
			</div>
         </div>
